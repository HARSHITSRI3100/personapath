    ...
    return (
      <div className="bg-zinc-900/70 border border-zinc-700/50 rounded-xl p-5 space-y-3">
        <div className="flex items-center gap-2">
          ...
          <p className="text-xs font-semibold text-zinc-400 uppercase tracking-widest">GPT-4o reading entry…</p>
        </div>
        {[...Array(3)].map((_, i) => (
  ...
  if (!analysis) {
    return (
      <div className="bg-zinc-900/50 border border-dashed border-zinc-700 rounded-xl p-4 text-center">
        <p className="text-zinc-600 text-xs mb-3">GPT-4o can analyse mood, sentiment & insights</p>
        <button
          onClick={onAnalyze}
  ...
  return (
    <div className="bg-zinc-900/70 border border-zinc-700/50 rounded-xl p-5 space-y-4">
      <div className="flex items-center gap-2">
        ...
        <p className="text-xs font-semibold text-zinc-400 uppercase tracking-widest flex-1">GPT-4o Analysis</p>
  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-zinc-400 text-sm mt-1">Write freely — GPT-4o analyses mood, sentiment & personality signals</p>
      </div>
